        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-1 border border-solid">
                <div class="flex justify-between">
                    <h1 class="px-2 py-4 m-2 float-right text-gray-800 text-2xl font-bold">permissions</h1>
                    <a href="{{ route('admin.permissions.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold px-6 py-3 m-4 rounded-md">
