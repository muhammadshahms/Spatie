                ...
                <div class="p-8 bg-white border-b border-gray-200">
                    <div class="mb-4 text-sm">
                        ...
                        <div class="p-2 mt-6 bg-slate-100 shadow-sm sm:rounded-lg">
                            <form class="flex flex-col gap-2" action="{{ route('admin.users.updateDetails', $user->id) }}" method="POST">
                                @method('PUT')
                                @csrf
                                <input type="text" class="border border-gray-300 rounded-md" name="name" value="{{ $user->name }}">
                                <input type="text" class="border border-gray-300 rounded-md mt-2" name="email" value="{{ $user->email }}">
                                <button type="submit" class="mt-2 px-4 py-2 bg-green-500 hover:bg-green-700 rounded-md">Edit</button>
                            </form>
